...
public:
    ...
    explicit Private(Chip8EmulatorHost& host, Cdp1802Bus& bus, const Chip8EmulatorOptions& options) : _host(host), _cpu(bus, CPU_CLOCK_FREQUENCY), _video(options.behaviorBase == Chip8EmulatorOptions::eCHIP8VIP_8X ? Cdp186x::eVP590 : Cdp186x::eCDP1861, _cpu, options) {}
...
static std::map<std::string,PatchSet> g_patchSets = {
    ...
    },
    {
        ...
        {{
            ...
            {0x2a0, {0x0c, 0xfb, 0x91, 0x32, 0xac, 0xf8, 0x91, 0x5c, 0xf8, 0x01, 0x5d, 0xd4, 0xf8, 0x00, 0x5d, 0xdf}},
...
{
    return _options.behaviorBase == Chip8EmulatorOptions::eCHIP8VIP_8X ? 27535.0f / ((unsigned)_impl->_frequencyLatch + 1) : 1400.0f;
}
